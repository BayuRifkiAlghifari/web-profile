...
<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
  ...
  <nav id="colorlib-main-menu" role="navigation">
    <ul>
        <li class="<?= is_active($page, 'about') ?>"><a href="<?= base_url ?>page/about">About</a></li>
        <li class="<?= is_active($page, 'project') ?>"><a href="<?= base_url ?>page/project">Project</a></li>
        <li class="<?= is_active($page, 'contact') ?>"><a href="<?= base_url ?>page/contact">Contact</a></li>
    </ul>
  </nav>
